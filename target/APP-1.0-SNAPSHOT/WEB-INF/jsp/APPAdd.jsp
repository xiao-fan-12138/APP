            ...
            <div class="right_col" role="main">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left"  action="App/AddApp" method="post" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="softwareName" placeholder="请输入软件名称" required="required" type="text">
                                </div>
                            </div>
                            <%--APK名称--%>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="email" name="APKName" required="required" class="form-control col-md-7 col-xs-12" placeholder="请输入APK名称">
                                </div>
                            </div>
                            <%--支持ROM--%>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="email2" name="supportROM" data-validate-linked="email" required="required" class="form-control col-md-7 col-xs-12" placeholder="请输入支持的ROM">
                                </div>
                            </div>
                            <%--界面语言--%>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="interfaceLanguage" name="interfaceLanguage"  class="form-control col-md-7 col-xs-12" placeholder="请输入软件的界面语言">
                                </div>
                            </div>
                            <%--软件大小--%>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="number" id="website" name="softwareSize" required="required"  class="form-control col-md-7 col-xs-12" placeholder="请输入软件的大小，单位为MB">
                                </div>
                            </div>
                            <%--下载次数--%>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="occupation" type="text" name="downloads" data-validate-length-range="5,20" class="optional form-control col-md-7 col-xs-12" placeholder="请输入软件的下载次数">
                                </div>
                            </div>
                            <%--所属平台--%>
                            <div class="item form-group">
