                    ...
                    <%--新增版本表单--%>
                        <form class="form-horizontal form-label-left"  action="version/addVersion" method="post" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                ...
                                <input id="appId" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="appId"  required="required" type="text" readonly="readonly" value="${appInfo.id}">
                            </div>
                            </div>
                            <%--版本号--%>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="versionNo" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="versionNo"  required="required" type="text" placeholder="请输入版本号" value="">
                                </div>
                            </div>
                            <%--版本大小--%>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="versionSize" name="versionSize" required="required" class="form-control col-md-7 col-xs-12" placeholder="版本大小" value="">
                                </div>
                            </div>
                            <%--发布状态--%>
                            <div class="item form-group">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea id="versionInfo" required="required" name="versionInfo" class="form-control col-md-7 col-xs-12"></textarea>
                                </div>
                            </div>
                            <%--LOGO图片--%>
                            <div class="item form-group">
